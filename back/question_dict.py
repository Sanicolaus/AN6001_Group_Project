...
mentalDict = {
    "How old are you?": "",
    "What is your gender?":["Female", "Male"],
    "If you have a mental health condition, you feel that it interferes with your work?": ["Don't know", "Never","Often","Rarely","Sometimes"],
    ...
    "Is your anonymity protected if you choose to take advantage of mental health or substance abuse treatment?":[
        "Don't know", "No", "Yes"],
    "How easy is it for you to take medical leave for a mental health condition?":["Don't know", "Somewhat difficult","Somewhat easy", "Very difficult","Very easy"],
    "Have you heard of or observed negative consequences for coworkers with mental health conditions in your company?":["No", "Yes"],
